    ...
    var imageDialog = function( editor, dialogType ) {
            ...
            function commitContent() {
                ...
                this.foreach( function( widget ) {
                    if ( widget.commit && widget.id != 'txtdlgGenStyle' )
                        ...
                        if (widget.id == "txtWidth"){
                            domIdWidth = widget.domId;
                        }
                        if (widget.id == "txtHeight"){
                            domIdHeight = widget.domId;
                        }
                });
            }

            function resizeImage(){
                var dih_split = domIdHeight.split("_")
                var h_dom_id = dih_split[1] - 2
                var diw_split = domIdWidth.split("_")
                var w_dom_id = diw_split[1] - 2
                var original_h = document.getElementById("cke_"+h_dom_id+"_textInput")
                var original_w = document.getElementById("cke_"+w_dom_id+"_textInput")
                if(original_h.value != ""){
                    original_h.value = ""
                }
                if(original_w.value != ""){
                    original_w.value = "100%"
            ...
            return {
                ...
                onOk: function() {
                    ...
                    caption.setText(getCaption(this.imageElement.$.dataset.caption));
